...
const TEMPLATE_TO_EVENT_TYPE: Record<string, string[]> = {
  ...
  fertilizer: ["Fertilizing", "Fertilizer Application", "Nutrient Application"],
  inspection: ["Inspection", "Field Inspection", "Plant Inspection"],
  "pest-control": ["Pest Control", "Disease Control", "Pest Management"],
}
